...
export default function Sidebar() {
  return (
    <div class="flex space-x-2">
      <div>
        <button
          class="inline-block ml-2 mt-2 px-3 py-2.5 bg-slate-800 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-slate-700 hover:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
          type="button"
